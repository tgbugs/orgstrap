# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 145c88502ede5df60bf2e4644908fc8204c1996517494d5b2e0f97a5cf4cafa5; -*-
...
(defun orgstrap--check-portable-subset (body)
  ...
  (let* ((l (flatten-tree (read (concat "(progn" body ")"))))
