...
(defcustom orgstrap-do-data nil "Retrieve external data needed by file.") ; TODO naming etc.
...
(defun defalias-local (symbol definition &optional docstring)
...
(defun raw-symbol-function (name)
  "Return unadvised form of NAME. NOT THREAD SAFE."
  (unwind-protect
      (progn
        (advice-remove name #'advice--has-local-defuns)
