# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1\.0; orgstrap-block-checksum: 42259645a8a9c5b1f09d5f10b633642540f2b12d2ba92ac8a720d5a268181b2f; -*-
...
the minimal local variables will be used if possible."
  ...
  (save-excursion
    ...
    (orgstrap--add-file-local-variables
     ...
     (cdr (assoc 'orgstrap-norm-func-name (orgstrap--read-current-local-variables))))
    (orgstrap-edit-mode 1)))
#+end_src
