...
(defun orgstrap-run-block ()
  ...
  (interactive)
  (save-excursion
    ;; FIXME the marker stack and `inhibit-message'
...
** TODO symlinks and vc
:PROPERTIES:
:CREATED:  [2021-08-02 Mon 01:23]
:END:
apparently orgstrap/hack-local-variables runs before
vc-follow-symlinks triggers or something?  oh for fucks sake people,
you can't fucking read file fucking local variables and THEN resolve
the fucking symlinks what the fuck?
