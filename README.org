# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-block-checksum: 2708c9e1bd52af5cb9c19f53491d3ea3fe34627c10042542635be4f5f63c23f0; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; -*-
...
# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: 9c636c7227f3ccdd095ccfc6335efd54d40edebe32120ce6be574e2e90fd734f; -*-
...
(defun orgstrap-test () (message "No local variables here!"))
(message "orgstrap successful")
,#+end_src
#+end_src

#+name: test-lv-list-portable
#+begin_src org :tangle ./test-lv-list-portable.org :noweb yes
# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: 603a9516e87fab71715b5c15cec401c497430de8fd2fa852394b52c3090fcd74; -*-
# [[orgstrap][jump to the orgstrap block for this file]]
...
,#+name: orgstrap
,#+begin_src elisp :results none :lexical yes
(defun orgstrap-test () (message "Portable local variables here!"))
(message "orgstrap successful")
,#+end_src
...
#+begin_src org :tangle ./test-lv-list-minimal.org :noweb yes
# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: 318708fa6836483faebffa30d6c1cca1deb235b0c8d64c3b2450b70aebe08d47; -*-
# [[orgstrap][jump to the orgstrap block for this file]]
...
,#+name: orgstrap
,#+begin_src elisp :results none :lexical yes
(defun orgstrap-test () (message "Minimal local variables here!"))
(message "orgstrap successful")
,#+end_src
<<local-variables-minimal-example>>
#+end_src

# TODO when we autogenerate test-safe-eval-vars.el print-escape-newlines nil must be set
# because that is how save local variables works now ... pretty sure that this is a bug
# that is actively breaking users saved variables lists as we speak due to the change in 27
# SIGH
...
test_files=( test-no-lv-list.org test-lv-list-portable.org test-lv-list-minimal.org )
for v in ${versions[@]}; do
for f in ${test_files[@]};do
#f=test-lv-list-minimal.org
#emacs -q \
emacs-$v -q --batch \
-l test-safe-eval-vars.el \
...
--eval "(add-to-list 'safe-local-variable-values '(orgstrap-norm-func-name . orgstrap-norm-func--prp-1.0))" \
--eval "(add-to-list 'safe-local-variable-values '(orgstrap-block-checksum .
9c636c7227f3ccdd095ccfc6335efd54d40edebe32120ce6be574e2e90fd734f))" \
--eval "(add-to-list 'safe-local-variable-values '(orgstrap-block-checksum .
603a9516e87fab71715b5c15cec401c497430de8fd2fa852394b52c3090fcd74))" \
--eval "(add-to-list 'safe-local-variable-values '(orgstrap-block-checksum .
318708fa6836483faebffa30d6c1cca1deb235b0c8d64c3b2450b70aebe08d47))" \
--visit $f \
--eval "(orgstrap-test)"
done
done
