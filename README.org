...
need to be broke out into its own file and published separately.].
** Posix bootstrap
...
*** Tests
Some test blocks to ensure shell portability.
#+begin_src powershell :noweb yes :results output
<<posix-powershell-switch>>
#+end_src

#+begin_src zsh :noweb yes :results output
<<posix-powershell-switch>>
#+end_src
** Emacs lisp
...
#+begin_src bash :noweb no-export :results output
...
#+begin_src sh :noweb no-export :results output
<<bootstrap-from-shell>>
#+end_src

Zsh
#+name: bootstrap-from-shell-zsh
#+begin_src zsh :noweb no-export :results output
<<bootstrap-from-shell>>
#+end_src
