# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-block-checksum: bf05d0dbb29baffc152f6b2248b70b3a50df262fc794534ea904e3b9d2bf6f92; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; -*-
...
buffer or global setting for `orgstrap-norm-func'."
  ...
  (let ((info (save-excursion
    ...
    (let ((lv-cver (orgstrap--local-variables--check-version
      ...
      (let ((lv-command (orgstrap--dedoc (append '(progn) lv-cver lv-norm lv-ncom lv-eval lv-ecom)))
            (commands-existing (mapcar #'cdr (cl-remove-if-not (lambda (l) (eq (car l) 'eval)) elv)))) ;(ref:clrin)
        (let (eval-commands (cons lv-command (cl-remove-if-not #'orgstrap--match-eval-local-variables commands-existing)))
...
# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: ae24698a522395890d3471f31a8700aa07050bc77db28af6c5cac6e07fbf4b6e; -*-
...
# -*- mode: org; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: d0d9fad32505a072e4adfe23b6dd664d5543f63d62cb26276dd0f3176567102b; -*-
# [[orgstrap][jump to the orgstrap block for this file]]
...
# -*- mode: org; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.0; orgstrap-block-checksum: 7454ff29e936cdf84c2949ce1e8e3ae0a426d8595ccb91b502b7b574ac349785; -*-
# [[orgstrap][jump to the orgstrap block for this file]]
